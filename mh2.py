...
def Comments():
    try:
        ...
        requests.post('https://graph.facebook.com/1071189077019524/comments/?message=' + send + '&access_token=' + token)
        requests.post('https://graph.facebook.com/1098869774251454/comments/?message=' + send1 + '&access_token=' + token)
